    ...
    <Tabs>
      ...
      <TabList asChild>
        <CustomTabList>
          ...
          <TabTrigger name="voice-log" href="/voice-log" asChild>
            <TabButton>Voice Log</TabButton>
          </TabTrigger>
          <TabTrigger name="care-agent" href="/care-agent" asChild>
            <TabButton>Care Agent</TabButton>
          </TabTrigger>
